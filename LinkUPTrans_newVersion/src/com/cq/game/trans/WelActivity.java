...
import com.cq.game.trans.view.GameView;
import com.cq.game.trans.view.OnStateListener;
import com.cq.game.trans.view.OnTimerListener;
import com.cq.game.trans.view.OnToolsChangeListener;
...
public class WelActivity extends Activity implements OnClickListener,
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
		case R.id.play_btn:
			Toast.makeText(this, "Loding...", Toast.LENGTH_LONG);
